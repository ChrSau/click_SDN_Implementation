...
#ifndef OFCLICK_SOCKET_HH
#define OFCLICK_SOCKET_HH 1
...
LIKE NORMAL SOCKET, BUT WITH AN EXTRA OUTPUT FOR CONNECTION CLOSED MESSAGE
...
class OFSocket : public Element { public:

  OFSocket() CLICK_COLD;
  ~OFSocket() CLICK_COLD;


  const char *class_name() const	{ return "OFSocket"; }
  const char *port_count() const	{ return "0-1/0-2"; }
...
private:
  ...
  WritablePacket *_connectionStatusMsg;
